...
namespace yost
{
    ...
    const char g_version[] = "YOST SKELETAL API 1.0.0";
    ...
    void Skeleton::setToStandardTPose()
    {
		...
		_skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_LEFT_JOYSTICK]] = Orient(-0.25f, -0.6f, -0.6f, 0.4f);			//GATHER MORE DATA
		...
		_skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_LEFT_JOYSTICK]] = Orient(0.6f, -0.3f, 0.25f, 0.65f);			//GATHER MORE DATA
    ...
    void Skeleton::setToStandardClaspedPose()
    {
        ...
        _skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_LEFT_HAND_PINKY_END]] = Orient();
		_skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_LEFT_JOYSTICK]] = Orient(-0.4f, 0.0f, -0.9f, 0.0f);			//GATHER MORE DATA
        ...
        _skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_RIGHT_HAND_PINKY_END]] = Orient();
		_skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_RIGHT_JOYSTICK]] = Orient(-0.4f, 0.0f, -0.9f, 0.0f);			//GATHER MORE DATA
    ...
    void Skeleton::setToStandardNeutralPose()
    {
        ...
        _skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_LEFT_HAND_PINKY_END]] = Orient();
		_skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_LEFT_JOYSTICK]] = Orient(-0.7f, -0.6f, 0.2f, 0.2f);			//GATHER MORE DATA
        ...
        _skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_RIGHT_HAND_PINKY_END]] = Orient();
		_skeleton_pose[g_standard_bone_names[YOST_SKELETON_BONE_RIGHT_JOYSTICK]] = Orient(-0.7f, -0.6f, 0.2f, 0.2f);			//GATHER MORE DATA
    ...
    YOST_SKELETON_ERROR Skeleton::getBoneOrientation(std::string bone_name, Orient* orient)
    {
        ...
        std::shared_ptr<Bone> bone = _bone_map[name_it->second];
        ...
        Orient finalOrient;
        orientMul(&bone->getOrientationOffset(), &boneOrient, &finalOrient);
